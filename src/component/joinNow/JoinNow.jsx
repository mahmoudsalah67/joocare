...
const [registeredEmail, setRegisteredEmail] = useState("");
 ...
 async function get(data) {
  ...
  <div className="contentt flex flex-col lg:flex-row w-full min-h-screen">
    ...
    {/* Left Panel */}
    <div className="left hidden lg:flex lg:w-1/2 bg-[#00422F] text-white p-8 xl:p-12 justify-center items-center lg:sticky lg:top-0 lg:h-screen">
      <div className="max-w-[513px]">
        <h2 className="text-[32px] xl:text-[48px] mb-[16px] xl:mb-[24px] font-[600] leading-tight">
          Match Faster <br /> work smarter
        </h2>
        <p className="text-[18px] xl:text-[21px] font-[400] text-justify opacity-90">
    ...
    <div className="right w-full lg:w-1/2 px-4 sm:px-10 py-10 lg:py-[60px] xl:py-[120px] flex justify-center items-center">
      <div className="w-full max-w-[539px] mx-auto">
        ...
        <div className="form mt-[24px]">
          <form onSubmit={handleSubmit(get)} className="space-y-[20px] xl:space-y-[24px]">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                className="p-[14px] xl:p-[16px] focus:border-[#00694B] outline-none transition duration-300 bg-[#0D0D0D0D] border-[1px] border-[#0D0D0D14] rounded-[999px] mt-[4px]"
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                className="p-[14px] xl:p-[16px] bg-[#0D0D0D0D] focus:border-[#00694B] outline-none transition duration-300 border-[1px] border-[#0D0D0D14] rounded-[999px] mt-[4px]"
                {...register("email", {
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <PhoneInput
                      ...
                      value={value}
                      onChange={onChange}
                      className="w-full h-[50px] xl:h-[56px] outline-none"
                    />
                  )}
                />
              </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center p-[14px] xl:p-[16px] bg-[#0D0D0D0D] border-[1px] border-[#0D0D0D14] rounded-[999px] focus-within:border-[#00694B] transition duration-300">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                {/* country_id */}
                <div className="flex w-full p-[14px] xl:p-[16px] bg-[#0D0D0D0D] border-[1px] border-[#0D0D0D14] rounded-[999px] focus-within:border-[#00694B]">
            ...
            <div className="flex flex-col relative">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="p-[14px] xl:p-[16px] w-full bg-[#0D0D0D0D] focus:border-[#00694B] outline-none transition duration-300 border-[1px] border-[#0D0D0D14] rounded-[999px] mt-[4px]"
                  {...register("password", {
            ...
            <div className="flex flex-col">
              ...
              <label htmlFor="cv"
                className={`flex flex-col justify-center items-center p-[20px] xl:p-[24px] rounded-[12px] bg-[#0D0D0D0D] border-[1px] border-dashed transition duration-500 cursor-pointer ${errors.cvFile ? 'border-red-500' : 'border-[#0D0D0D14] hover:border-[#00694B]'}`}>
              ...
              {watch("has_medical_license") && (
                <div className="space-y-4 bg-gray-50 p-4 rounded-2xl border border-gray-100">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="p-[14px] xl:p-[16px] bg-white border-[1px] border-[#0D0D0D14] rounded-[999px] focus-within:border-[#00694B]">
                  ...
                  <div className="flex flex-col">
                    ...
                    <input type="text" placeholder="ex: MOH, DOH, CST"
                      className="p-[14px] xl:p-[16px] bg-white focus:border-[#00694B] outline-none transition border-[1px] border-[#0D0D0D14] rounded-[999px] mt-[4px]"
                  ...
                  <div className="flex flex-col">
                    ...
                    <input type="text" placeholder="ex: 23121212"
                      className="bg-white border-[1px] mt-[4px] p-[14px] xl:p-[16px] rounded-full outline-none focus:border-[#00694B] border-[#0D0D0D14]"
                  ...
                  <div className="flex flex-col">
                    ...
                    <label htmlFor="license-file"
                      className="flex flex-col justify-center items-center p-[20px] xl:p-[24px] rounded-[12px] bg-white border-[1px] border-dashed border-[#0D0D0D14] hover:border-[#00694B] cursor-pointer transition duration-500">
                      <img src={cv} alt="" className="mb-2" />
            ...
            <button
              type="submit"
              disabled={loading}
              className="py-[14px] xl:p-[16px] cursor-pointer px-[32px] w-full sm:w-[223px] flex items-center justify-center mt-[32px] mx-auto bg-[#00694B] hover:bg-black transition duration-500 rounded-full text-white font-bold disabled:bg-gray-400"
            >
