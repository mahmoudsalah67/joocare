...
function ChangePassword() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await api.post("/company/auth/change-password", {
  ...
  return (
    <div className="bg-white rounded-[32px] p-10 border border-[#F1F1F1] shadow-[0_4px_25px_rgba(0,0,0,0.03)] w-full max-w-[1000px] mx-auto">
