  ...
  async function fetchdatadomain() {
    try {
      const response = await fetch(
        "https://joocare.nami-tec.com/api/domains?pagination=on&limit_per_page=10&page=1"
      );
      ...
      >
        <div className="section-forcandidate bg-white transition-all duration-500">
          <div className="contentt flex flex-col lg:flex-row w-full min-h-screen">
            {/* LEFT SECTION */}
            <div className="left hidden lg:flex lg:w-1/2 sticky top-0 flex items-center justify-center h-screen pl-8 xl:pl-[30px] bg-[#00422F] text-white">
              <div className="middle max-w-[513px]">
                <div className="title">
                  <h2 className="text-[32px] xl:text-[48px] mb-[16px] xl:mb-[24px] font-[600] leading-tight flex items-center">
            ...
            {/* RIGHT SECTION (FORM) */}
            <div className="right w-full mt-10 lg:w-1/2 px-4 sm:px-10 pt-10 pb-10 lg:pt-[60px] xl:pt-[120px] lg:pb-[100px]">
              <div className="content w-full max-w-[539px] mx-auto">
                <div className="title">
                  <h2 className="text-3xl sm:text-4xl xl:text-[48px] font-[700]">
                    Start your business
                  </h2>
                </div>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="name flex flex-col">
                      ...
                      <input
                        ...
                        id="name"
                        placeholder="ex:Nami"
                        className={`p-[14px] xl:p-[16px] focus:border-[#00694B] outline-none transition duration-300 bg-[#0D0D0D0D] border rounded-[999px] mt-[4px] ${errors.name ? "border-red-500" : "border-[#0D0D0D14]"}`}
                        {...register("name", {
                    ...
                    <div className="email flex flex-col mt-[24px]">
                      ...
                      <input
                        ...
                        className={`p-[14px] xl:p-[16px] bg-[#0D0D0D0D] focus:border-[#00694B] outline-none transition duration-300 border rounded-[999px] mt-[4px] ${errors.email ? "border-red-500" : "border-[#0D0D0D14]"}`}
                        {...register("email", {
                    ...
                    <div className="flex flex-col mt-[24px]">
                      ...
                      <div
                        className={`flex justify-between items-center p-[14px] xl:p-[16px] bg-[#0D0D0D0D] border rounded-[999px] focus-within:border-[#00694B] transition duration-300 ${errors.domain ? "border-red-500" : "border-[#0D0D0D14]"}`}
                      >
                        <select
                    ...
                    <div className="name flex flex-col mt-[24px]">
                      ...
                      <input
                        ...
                        id="person_name"
                        placeholder="ex:Nami"
                        className={`p-[14px] xl:p-[16px] focus:border-[#00694B] outline-none transition duration-300 bg-[#0D0D0D0D] border rounded-[999px] mt-[4px] ${errors.Contactperson ? "border-red-500" : "border-[#0D0D0D14]"}`}
                        ...
                        <Controller
                          ...
                          render={({ field: { onChange, value } }) => (
                            <PhoneInput
                              ...
                              value={value}
                              onChange={onChange}
                              className="w-full h-[50px] xl:h-[56px]"
                            />
                          )}
                        />
                      </div>
                    ...
                    <div className="password flex flex-col mt-[24px] relative">
                      ...
                      <div className="relative">
                        <input
                          ...
                          id="password"
                          placeholder="••••••••"
                          className={`p-[14px] xl:p-[16px] w-full bg-[#0D0D0D0D] focus:border-[#00694B] outline-none transition duration-300 border rounded-[999px] mt-[4px] ${errors.password ? "border-red-500" : "border-[#0D0D0D14]"}`}
                          {...register("password", {
                    ...
                    <div className="contant2 mt-[24px]">
                      ...
                      <div className="mb-[18px]">
                        <label className="flex items-start gap-[12px] cursor-pointer group">
                          ...
                          <p className="text-[#0D0D0D] text-base sm:text-[18px] leading-[1.3] font-[400]">
                      ...
                      <div>
                        <label className="flex items-start gap-[12px] cursor-pointer">
                          ...
                          <p className="text-[#0D0D0D] text-base sm:text-[18px] leading-[1.3]">
                            I agree to the{" "}
                    ...
                    <button
                      type="submit"
                      className="py-[14px] xl:py-[16px] px-[32px] w-full sm:w-[223px] flex items-center justify-center mt-[32px] mx-auto bg-[#00694B] hover:bg-black transition duration-500 rounded-full text-white font-bold cursor-pointer"
                    >
                      Register
                    </button>
