            ...
            <div className="flex flex-col lg:flex-row gap-6 px-4 sm:px-8 lg:px-10 w-full">
              ...
              <main className="w-full lg:flex-1 py-10 lg:py-[70px]">
                <div className="profile-details px-4 sm:px-8 lg:px-[40px] py-6 sm:py-[32px] bg-[#F7FAF7] min-h-screen">
                  <h2 className="text-[18px] sm:text-[20px] font-bold text-[#0D0D0D] mb-6">Active Jobs</h2>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8">
                    <div className="bg-white p-5 sm:p-6 rounded-[24px] shadow-sm border border-gray-50 relative overflow-hidden">
                      ...
                      <h3 className="text-[28px] sm:text-[32px] font-bold text-[#00694B]">{dashboardData?.active_jobs || 0}</h3>
                    ...
                    <div className="bg-white p-5 sm:p-6 rounded-[24px] shadow-sm border border-gray-50">
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <h3 className="text-[28px] sm:text-[32px] font-bold text-[#00694B]">{dashboardData?.total_applications || 0}</h3>
                    ...
                    <div className="bg-white p-5 sm:p-6 rounded-[24px] shadow-sm border border-gray-50">
                      ...
                      <div className="flex items-center justify-between">
                        <h3 className="text-[28px] sm:text-[32px] font-bold text-[#00694B]">+{dashboardData?.applications_latest_activity || 0} <span className="text-[16px] font-bold">Application</span></h3>
                        <img src={acctive} alt="" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col lg:flex-row gap-6">
                    <div className="w-full lg:basis-1/3 space-y-6">
                      <div className="bg-white p-5 sm:p-6 rounded-[24px] shadow-sm border border-gray-50">
                        ...
                        <div className="flex items-center justify-between">
                          <h3 className="text-[28px] sm:text-[32px] font-bold text-[#00694B]">{dashboardData?.cvs_downloaded || 0}</h3>
                          <img src={Correct} alt="" />
                        </div>
                      </div>
