            ...
            <div className="w-full max-w-[500px]">
              ...
              <div className="mt-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button type="button" className="flex-1 flex items-center justify-center gap-3 py-3 px-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all cursor-pointer">
